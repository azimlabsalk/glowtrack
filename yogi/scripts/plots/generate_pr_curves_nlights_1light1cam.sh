...
yogi plot pr-comparison-labelset output/fig4/pr-curves-cerebro-nlights-panel1.eps cerebro-1-cam-1-light-test right-paw cerebro-1-cam-1-light-test cerebro-train-scale-0.8 cerebro-clipgroup-train-lights-0-4-2-6 cerebro-clipgroup-train-lights-0-4 --subsample-conf 1
