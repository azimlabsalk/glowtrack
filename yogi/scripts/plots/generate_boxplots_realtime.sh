...
yogi plot error-boxplot-labelset output/fig4/boxplot-headfix-view1.eps realtime-headfix-mono-view1-labeled right-paw realtime-headfix-mono-views123-labeled cerebro-global-0.8-long-autoscale-conf --ymax 1000 --whis 0 --logplot 1
yogi plot error-boxplot-labelset output/fig4/boxplot-headfix-view2.eps realtime-headfix-mono-view2-labeled right-paw realtime-headfix-mono-views123-labeled cerebro-global-0.8-long-autoscale-conf --ymax 1000 --whis 0 --logplot 1
yogi plot error-boxplot-labelset output/fig4/boxplot-headfix-view3.eps realtime-headfix-mono-view3-labeled right-paw realtime-headfix-mono-views123-labeled cerebro-global-0.8-long-autoscale-conf --ymax 1000 --whis 0 --logplot 1
