...
# panel 2
# yogi plot error-boxplot-labelset output/fig4/error-boxplot-cerebro-ntraining-new.eps cerebro-clipgroup-test-0.05 right-paw cerebro-clipgroup-test cerebro-clipgroup-train-5000 cerebro-clipgroup-train-20000 cerebro-train-scale-0.8

# panel 3

# yogi plot error-boxplot-labelset output/fig4/error-boxplot-cerebro-ncams.eps cerebro-clipgroup-test-0.05 right-paw cerebro-clipgroup-test cerebro-clipgroup-train-cams-3-5 cerebro-clipgroup-train-cams-3-5-2-7 cerebro-train-scale-0.8 --ymax 25 --whis 0 --logplot 0

# yogi plot error-boxplot-labelset output/fig4/error-boxplot-challenge-ncams.eps challenge-2-left-with-flipped-labeled left-paw challenge-2-left-with-flipped cerebro-clipgroup-train-cams-3-5-flipped cerebro-clipgroup-train-cams-3-5-2-7-flipped cerebro-train-scale-0.8-flipped --ymax 25 --whis 0 --logplot 0

yogi plot error-boxplot-labelset output/fig4/error-boxplot-challenge-ncams-autoscale.eps challenge-2-left-with-flipped-labeled left-paw challenge-2-left-with-flipped cerebro-clipgroup-train-cams-3-5-flipped-autoscale-conf cerebro-clipgroup-train-cams-3-5-2-7-flipped-autoscale-conf cerebro-train-scale-0.8-flipped-autoscale-conf --ymax 60 --whis 0 --logplot 0

# yogi plot error-boxplot-labelset output/fig4/error-boxplot-challenge-ntraining-new.eps challenge-2-left-with-flipped-labeled left-paw challenge-2-left-with-flipped cerebro-clipgroup-train-5000-flipped cerebro-clipgroup-train-20000-flipped cerebro-train-scale-0.8-flipped
