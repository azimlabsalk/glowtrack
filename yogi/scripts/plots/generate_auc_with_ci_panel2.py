...
# panel 2
# cerebro-clipgroup-test-0.05 right-paw cerebro-clipgroup-test cerebro-train-250 cerebro-train-500 cerebro-train-1000 cerebro-train-1000-diverse cerebro-train-scale-0.8

df_fig4_panel2 = imageset_auc_table(session, imageset_names=['cerebro-clipgroup-test-0.05'],
                          label_source_names=[
                            'cerebro-train-250',
                            'cerebro-train-500',
                            'cerebro-train-1000',
                            'cerebro-train-1000-diverse',
                            'cerebro-train-scale-0.8',
                          ],
                          gt_labelset_name='cerebro-clipgroup-test',
                          landmarkset_name='right-paw',
                          threshold_units='normalized', error_threshold=0.05,
                          use_occluded_gt=True)
...
# pabel 2 on old test dataset that overlapped with training
