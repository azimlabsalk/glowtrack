...
yogi plot pr-comparison-labelset output/fig4/pr-curves-cerebro-nlights.eps cerebro-clipgroup-test-0.05 right-paw cerebro-clipgroup-test cerebro-train-scale-0.8 cerebro-clipgroup-train-lights-0-4-2-6 cerebro-clipgroup-train-lights-0-4 --subsample-conf 1

yogi plot pr-comparison-labelset output/fig4/pr-curves-challenge-nlights.eps challenge-2-left-with-flipped-labeled left-paw challenge-2-left-with-flipped cerebro-clipgroup-train-lights-0-4-flipped cerebro-clipgroup-train-lights-0-4-2-6-flipped cerebro-train-scale-0.8-flipped --subsample-conf 1
