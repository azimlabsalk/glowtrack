...
yogi plot error-boxplot-labelset output/fig4/error-boxplot-challenge-ntraining-new.eps challenge-2-left-with-flipped-labeled left-paw challenge-2-left-with-flipped cerebro-clipgroup-train-5000-flipped cerebro-clipgroup-train-20000-flipped cerebro-train-scale-0.8-flipped --ymax 600 --whis 0 --logplot 0

yogi plot error-boxplot-labelset output/fig4/error-boxplot-challenge-ntraining-autoscale.eps challenge-2-left-with-flipped-labeled left-paw challenge-2-left-with-flipped cerebro-clipgroup-train-5000-flipped-autoscale-conf cerebro-clipgroup-train-20000-flipped-autoscale-conf cerebro-train-scale-0.8-flipped-autoscale-conf --ymax 300 --whis 0 --logplot 0
