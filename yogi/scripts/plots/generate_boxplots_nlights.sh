...
yogi plot error-boxplot-labelset output/fig4/error-boxplot-challenge-nlights-autoscale.eps challenge-2-left-with-flipped-labeled left-paw challenge-2-left-with-flipped cerebro-clipgroup-train-lights-0-4-flipped-autoscale-conf cerebro-clipgroup-train-lights-0-4-2-6-flipped-autoscale-conf cerebro-train-scale-0.8-flipped-autoscale-conf --ymax 60 --whis 0 --logplot 0
