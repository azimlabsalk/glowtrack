...
# yogi plot pr-comparison-labelset output/fig4/pr-curves-cerebro-ncams.eps cerebro-clipgroup-test-0.05 right-paw cerebro-clipgroup-test cerebro-clipgroup-train-cams-3-5 cerebro-clipgroup-train-cams-3-5-2-7 cerebro-train-scale-0.8 --subsample-conf 1

# yogi plot pr-comparison-labelset output/fig4/pr-curves-challenge-ncams.eps challenge-2-left-with-flipped-labeled left-paw challenge-2-left-with-flipped cerebro-clipgroup-train-cams-3-5-flipped cerebro-clipgroup-train-cams-3-5-2-7-flipped cerebro-train-scale-0.8-flipped --subsample-conf 1

yogi plot pr-comparison-labelset output/fig4/pr-curves-challenge-ncams-autoscale.eps challenge-2-left-with-flipped-labeled left-paw challenge-2-left-with-flipped cerebro-clipgroup-train-cams-3-5-flipped-autoscale-conf cerebro-clipgroup-train-cams-3-5-2-7-flipped-autoscale-conf cerebro-train-scale-0.8-flipped-autoscale-conf --subsample-conf 1


# panel 3

# yogi plot pr-comparison-labelset output/fig4/pr-curves-challenge-ncams.eps challenge-2-left-with-flipped-labeled left-paw challenge-2-left-with-flipped cerebro-clipgroup-train-cams-3-5 cerebro-train-scale-0.8-flipped --subsample-conf 1
