...
from deepercut.dataset.factory import create as create_dataset
from deepercut.nnet.net_factory import pose_net
from deepercut.nnet.pose_net import get_batch_spec
...
def train(config_file=None, dataset=None):
    setup_logging()
